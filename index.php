<link rel="stylesheet" type="text/css" href="kurss.css">
<?php include('header.php'); ?>
<body>
<?php include('navbar.php'); ?>
<div class="container">
	<h1 class="page-header text-center">Pieejamie automobīļi</h1>
								...
								<div class="col-md-3">
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<img src="<?php if(empty($pfrow['photo'])){echo "upload/noimage.jpg";} else{echo $pfrow['photo'];} ?>" height="150px" width="100%";>
										</div>
							...
							?>
								<div class="col-md-3">
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<img src="<?php if($prow['photo']==''){echo "upload/noimage.jpg";} else{echo $prow['photo'];} ?>" height="150px" width="100%";>
										</div>
										<div class="panel-footer text-center">
